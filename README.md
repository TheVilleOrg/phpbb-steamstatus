...
* Adds a profile field that accepts a SteamID in an format (SteamID, SteamID3, SteamID64, or Steam Community profile URL/vanity name), which is converted to SteamID64
